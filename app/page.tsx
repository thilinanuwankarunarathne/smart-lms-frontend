...
import HeroImage from "./Assets/LearningStyles.jpg";
    ...
    try {
      if (role === "student") {
        ...
        if (res.ok) {
          ...
          console.log(
            "Student login successful, token stored:",
            data.studentId,
          );
        ...
        <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-16 items-center">
          <div className="hidden lg:flex flex-col justify-center h-full space-y-8">
            ...
            <p className="text-xl text-slate-600 font-medium max-w-md leading-relaxed">
              Learning styles show how people learn-visual by seeing, auditory
              by listening, and kinesthetic by doing.
            </p>
            ...
            <div className="p-8 md:p-10">
              <div className="mb-8 text-center">
                ...
                <p className="text-slate-500 text-sm font-medium">
                  {role === "student"
                    ? isLogin
                      ? "Please login to continue your lessons."
                  ...
                  <>
                    <div className="relative group">
                      ...
                      <input
                        ...
                        className="w-full pl-11 pr-4 py-4 rounded-xl bg-slate-50 border-2 border-slate-100 outline-none focus:border-indigo-500 focus:bg-white transition-all font-bold text-slate-700"
                        onChange={(e) =>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          adminIdentifier: e.target.value,
                        })
                      }
                    />
                  </div>
